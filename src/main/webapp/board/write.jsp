...
<c:if test="${empty loginMember}">
    <c:set scope="session" var="message" value="게시판 글쓰기는 회원만 가능합니다!"/>
    <c:set var="referer" value="/board/write.jsp" scope="session"/>
        ...
        <div class="page-title">
            <div class="container">
                ...
                <div class="write-add">
                    ...
                    <button type="button" class="write-cancel" onclick="location.href='board.jsp'">취소</button>
                </div>
            </div>
        </div>
    </section>
